...
//Test to catch invalid customer name
	...
	/*
	 * Test #: 3 Test Objective: Catch invalid Price Inputs: id = 0 Expected Output:
	 * Exception Message -> "Price must be greater than 0"
	 */
...
//Test to catch invalid customer name
	...
	/*
	 * Test #: 4 Test Objective: Catch invalid Price Inputs: id = 1000000001
...
//Test to catch invalid customer name
	...
	/*
	 * Test #: 5 Test Objective: Catch invalid Quantity Inputs: id = 0 Expected
...
//Test to catch invalid customer name
	...
	/*
	 * Test #: 6 Test Objective: Catch invalid Quantity Inputs: id = 11 Expected
	 * Output: Exception Message -> Quantity must be less than 11
	 */
...
//Test to catch invalid customer name
	...
	/*
	 * Test #: 7 Test Objective: Catch invalid publication Inputs: id = "" Expected
...
//Test to catch invalid customer name
	...
	/*
	 * Test #: 8 Test Objective: Catch invalid publication Inputs: id = "ab"
	...
	/*
	 * Test #: 9 Test Objective: Catch invalid publication Inputs: id =
	 * "abcdefghijklmnopq" Expected Output: Exception Message -> Publication name
